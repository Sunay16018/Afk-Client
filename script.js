...
document.getElementById("autoMsgEnable").onchange = ()=>{
 s.emit("autoMsg",{username: document.getElementById("username").value,enabled: document.getElementById("autoMsgEnable").checked,message: document.getElementById("autoMsgText").value,delay:Number(document.getElementById("autoMsgDelay").value||5)});
};
